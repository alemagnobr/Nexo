...
export const WalletsView: React.FC<WalletsViewProps> = ({ wallets, transactions = [], onAdd, onUpdate, onDelete, onTransfer, onUpdateTransaction, onAddTransaction }) => {
                     ...
                     {card.creditLimit ? (
                      ...
                      {onAddTransaction && (
                         <button
                           ...
                           className="mt-3 w-full py-1.5 px-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs rounded-lg transition-all flex items-center justify-center gap-1 cursor-pointer shadow-md shadow-indigo-600/10 hover:shadow-indigo-600/25 active:scale-[0.98]"
                         >
