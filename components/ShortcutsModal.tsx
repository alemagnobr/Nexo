            ...
            {shortcuts.map((shortcut) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs md:text-sm font-bold text-slate-700 dark:text-slate-200 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 leading-tight">
                    {shortcut.name}
                  </p>
                </div>
              </button>
